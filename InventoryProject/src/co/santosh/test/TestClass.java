...
public class TestClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("ItemId\tItemName\tItemPrice\tItemProductId\tItemStatus");
		for(Item item : items){
			System.out.println(item.getId()+"\t"+item.getItemName()+"\t\t"+item.getItemPrice()+"\t\t"+item.getProductId().getId()+"\t\t"+item.isStatus());
		}
